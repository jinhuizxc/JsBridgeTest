package com.github.lzyzsd.jsbridge.action;
...
public class BridgeUtil {
	...
	final static String JS_HANDLE_MESSAGE_FROM_JAVA = "javascript:Action._handleMessageFromNative('%s');";
	final static String JS_FETCH_QUEUE_FROM_JAVA = "javascript:Action._fetchQueue();";
	public final static String JAVASCRIPT_STR = "javascript:";

	// 例子 javascript:Action._fetchQueue(); --> _fetchQueue
	public static String parseFunctionName(String jsUrl){
		return jsUrl.replace("javascript:Action.", "").replaceAll("\\(.*\\);", "");
	}
